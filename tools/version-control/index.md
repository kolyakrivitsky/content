...
Системы контроля версий, или VSC (version control systems) придумали, чтобы следить за историей изменений исходного кода и комфортно работать над ним большой командой.
